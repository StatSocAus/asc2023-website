...
# Download a complete copy of the ASC 2023 website.
...
wget \
    ...
    --execute robots=off  \
    --span-hosts          \
    --domains=asc2023.org,assets.squarespace.com,fonts.googleapis.com,fonts.gstatic.com,images.squarespace-cdn.com,static1.squarespace.com \
